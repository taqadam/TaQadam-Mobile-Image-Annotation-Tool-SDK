...
public class JobOld {
    ...
    private List<ImageOld> imagesList;
    ...
    public List<ImageOld> getImagesList() {
        return imagesList;
    }

    public void removeeImage(String imageId) {
        Iterator<ImageOld> i = imagesList.iterator();
        while (i.hasNext()) {
            ImageOld image = i.next();
    ...
    public void setImages(Map<String, Map<String, Object>> val) {
        ...
        Collections.sort(imagesList, new Comparator<ImageOld>() {
            @Override
            public int compare(ImageOld o1, ImageOld o2) {
